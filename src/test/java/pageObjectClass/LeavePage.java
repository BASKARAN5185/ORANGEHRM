...
public class LeavePage extends BaseClass {
	...
	By leaveTypeDropdown = By
			.xpath("(//div[@class='oxd-select-text-input'])[2]");

	// 6. Employee Name Autocomplete
    By employeeNameInput = By.xpath("//input[@placeholder='Type for hints...']");

	// 7. Sub Unit Dropdown
	public static By subUnitDropdown = By
			.xpath("(//div[@class='oxd-select-text-input'])[3]");

	// 8. Include Past Employees Checkbox
	public static By includePastEmployeesCheckbox = By
			.xpath("//span[contains(@class,'oxd-switch-input oxd-switch-input--active')]");

	// 9. Search Button
	public static By searchButton = By.xpath("(//button[contains(@class,'oxd-button oxd-button--medium')])[2]");

	// 10. Reset Button
	public static By resetButton = By.xpath("(//button[contains(@class,'oxd-button oxd-button--medium')])[1]");

	// 11. Filter Panel Toggle Button
	public static By filterToggleButton = By.xpath("//div[@class='oxd-table-filter-header-options']//button");

	// 12. Export Button
	public static By exportButton = By.xpath("//div[@class='oxd-table-filter-header-options']//div[@class='--export']");

	// 13. Leave Table (Leave List)
	public static By leaveTable = By.xpath("//table[@class='oxd-table']");

	// 14. Individual Leave Row (First Row in Table)
	public static By leaveRow = By.xpath("//table[@class='oxd-table']/tbody/tr[1]");

	// 15. Leave Status Chip (Example for Pending Approval)
	public static By leaveStatusChip = By.xpath("//span[@class='oxd-chip oxd-chip--default']");

	// 16. Leave Type (inside the table)
	public static By leaveTypeColumn = By.xpath("//table[@class='oxd-table']//td[text()='Leave Type']");

	// 17. Leave Action Button (for each leave record)
	public static By leaveActionButton = By.xpath("//table[@class='oxd-table']//button[contains(text(),'Action')]");

	// 18. Leave Details Page (after clicking Action)
	public static By leaveDetailsPage = By.xpath("//div[@class='leave-details-page']");

	// 19. Leave Request Form - Request Leave Button
	public static By requestLeaveButton = By.xpath("//button[text()='Request Leave']");
	...
	public static By leaveDateField = By.xpath("//label[text()='From Date']/following-sibling::div//input");

	// 22. Leave Status Dropdown (Inside Leave Request Form)
	public static By leaveStatusInRequestForm = By
	...
	public void selectLeaveType(String type) {
		...
		WebElement typeOption = driver
				.findElement(By.xpath("//div[@class='oxd-select-text']//span[text()='" + type + "']"));
		typeOption.click(); // Select the type
	}
	...
	public void selectSubUnit(String subUnit) {
		...
		WebElement subUnitOption = driver
				.findElement(By.xpath("//div[@class='oxd-select-text']//span[text()='" + subUnit + "']"));
		subUnitOption.click(); // Select subunit
	}
